  ...
  return (
    <div className="about-page page-container">
      ...
      <div className="about-grid">
        ...
        <div className="about-text">
          <p>
            <b>Struggles</b>Lorem ipsum dolor sit amet consectetur adipisicing
            elit. Ex ad sapiente vero iure laboriosam repellat dicta. Nihil
            possimus earum ad? Eos tenetur cumque explicabo rem dolorum porro
            quis magnam corrupti.
          </p>
        </div>
